...
# Form implementation generated from reading ui file '14_calender_select_ok_cancel.ui'
#
...
class Ui_new_droplist_dialog(object):
    def setupUi(self, new_droplist_dialog):
        ...
        new_droplist_dialog.resize(500, 350)
        ...
        new_droplist_dialog.setMinimumSize(QtCore.QSize(500, 350))
        new_droplist_dialog.setMaximumSize(QtCore.QSize(500, 350))
        ...
        self.calendarWidget = QtWidgets.QCalendarWidget(new_droplist_dialog)
        font = QtGui.QFont()
